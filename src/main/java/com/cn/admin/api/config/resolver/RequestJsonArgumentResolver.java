...
public class RequestJsonArgumentResolver extends AbstractNamedValueMethodArgumentResolver implements UriComponentsContributor {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        ...
        boolean bool = parameter.getParameterAnnotations() == null || parameter.getParameterAnnotations().length == 0
                || parameter.hasParameterAnnotation(RequestJson.class) || parameter.hasParameterAnnotation(NotNull.class)
                || parameter.hasParameterAnnotation(NotBlank.class);
//        log.info("是否解析参数：{}", bool);
        return bool;
    }
    ...
    protected NamedValueInfo createNamedValueInfo(MethodParameter parameter) {
        ...
        return (ann == null ? new RequestJsonNamedValueInfo() : new RequestJsonNamedValueInfo(ann));
...
//                    }
    ...
    public static boolean isWrapClass(Class clz) {
        try {
            if (clz.equals(String.class) || clz.equals(Number.class)) {
                return true;
            }
